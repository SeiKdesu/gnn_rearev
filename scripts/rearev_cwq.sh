...
python main.py ReaRev --entity_dim 50 --num_epoch 100  --batch_size 4 --eval_every 1 --lm relbert --num_iter 2 --num_ins 3   --name cwq --data_folder data/CWQ/ --warmup_epoch 80  --data_eff
