...
WANDB_API_KEY="66a8159cb49efe62675286b7216aecb7360a03a3" python main.py ReaRev --entity_dim 50 --num_epoch 100 --batch_size 8 --eval_every 2 --lm relbert --num_iter 2 --num_ins 3   --name webqsp --experiment_name dropout-0.2 --data_folder data/webqsp/ --warmup_epoch 80
